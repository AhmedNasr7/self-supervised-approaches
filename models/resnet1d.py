...
class ResNet1D(nn.Module):
    ...
    def __init__(self, in_channels, base_filters, kernel_size, stride, groups, n_block, n_classes, downsample_gap=2, increasefilter_gap=4, \
                    use_bn=True, use_do=True, zero_init_residual =True,  verbose=False):
        ...
        for i_block in range(self.n_block):
            ...
            if self.zero_init_residual:
                nn.init.constant_(tmp_block.bn2.weight, 0)
...
class ResNet1d_Backbone(nn.Module):
    ...
    def __init__(self, num_classes=3, in_channels=1, zero_init_residual=True):
        super(ResNet1d_Backbone, self).__init__()
...
if __name__ == "__main__":
    ...
    # summary(model, (x.shape[1], x.shape[2]))
